...
import { HomeOutlined, LikeOutlined, LoginOutlined, LogoutOutlined, MenuFoldOutlined, MenuOutlined, MenuUnfoldOutlined, SettingOutlined, UserOutlined } from '@ant-design/icons';
			...
			<MVRow
				...
				<MVCol span={20}>
					<MVRow
						...
						<MVCol className='ml-5 text-[15px] lg:text-[17px] md:text[16px]' style={{ marginLeft: "50px" }} onClick={handleCheckCart}>
