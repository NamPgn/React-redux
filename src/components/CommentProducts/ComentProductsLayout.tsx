...
const ComentProductsLayout = ({ setCommentAdded }) => {
  ...
  try {
    ...
    return <Divstyled className='text-light des'>
      <Divstyled className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
        <Divstyled className="flex items-center justify-between px-3 py-2 border-b dark:border-gray-600">
          <Divstyled className="flex flex-wrap items-center divide-gray-200 sm:divide-x dark:divide-gray-600">
            <Divstyled className="flex items-center space-x-1 sm:pr-4">
              <BtnStyled type="button" className="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                ...
                <SpanStyled className="sr-only">Attach file</SpanStyled>
              </BtnStyled>
              <BtnStyled type="button" className="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                ...
                <SpanStyled className="sr-only">Embed map</SpanStyled>
              </BtnStyled>
              <BtnStyled type="button" className="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                ...
                <SpanStyled className="sr-only">Upload image</SpanStyled>
              </BtnStyled>
              <BtnStyled type="button" className="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                ...
                <SpanStyled className="sr-only">Format code</SpanStyled>
              </BtnStyled>
              <BtnStyled type="button" className="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                ...
                <SpanStyled className="sr-only">Add emoji</SpanStyled>
              </BtnStyled>
            </Divstyled>
            <Divstyled className="flex flex-wrap items-center space-x-1 sm:pl-4">
              <BtnStyled type="button" className="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                ...
                <SpanStyled className="sr-only">Add list</SpanStyled>
              </BtnStyled>
              <BtnStyled type="button" className="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                ...
                <SpanStyled className="sr-only">Settings</SpanStyled>
              </BtnStyled>
              <BtnStyled type="button" className="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                ...
                <SpanStyled className="sr-only">Timeline</SpanStyled>
              </BtnStyled>
              <BtnStyled type="button" className="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                ...
                <SpanStyled className="sr-only">Download</SpanStyled>
              </BtnStyled>
            </Divstyled>
          </Divstyled>
          <BtnStyled type="button" data-tooltip-target="tooltip-fullscreen" className="p-2 text-gray-500 rounded cursor-pointer sm:ml-auto hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
            ...
            <SpanStyled className="sr-only">Full screen</SpanStyled>
          </BtnStyled>
          <Divstyled id="tooltip-fullscreen" role="tooltip" className="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
            Show full screen
            <Divstyled className="tooltip-arrow" data-popper-arrow></Divstyled>
          </Divstyled>
        </Divstyled>
        <Divstyled className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
          <label htmlFor="editor" className="sr-only">Publish post</label>
          <textarea onChange={(e) => setS({ ...s, commentContent: e.target.value })} id="editor" rows={rows} className="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
        </Divstyled>
      </Divstyled>
    ...
    return <Link to={'/auth/signin'}>
      <Divstyled className='text-center mt-4 des text-primary'>
