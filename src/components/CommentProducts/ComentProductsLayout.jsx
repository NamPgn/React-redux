    ...
    return <Divstyled className='text-light des'>
      <Divstyled className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
        ...
        <Divstyled className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
          ...
          <textarea onChange={(e) => setS({ ...s, commentContent: e.target.value })} id="editor" rows="5" className="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
        </Divstyled>
      </Divstyled>
