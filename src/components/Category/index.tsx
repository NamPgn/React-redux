      ...
      {c && <Divstyled key={c._id}>
        <Divstyled style={{ color: "#fff" }}>
          <Divstyled className='md:flex lg:flex block gap-2 '>
            ...
            <Divstyled className="lg:w-9/12 md:w-9/12">
              <Divstyled className="category">
                <DivstyledTitle className="md:text-[18px] lg:text-[20px] sm:text-[15px]" style={{ textTransform: 'capitalize' }}>{c.name}</DivstyledTitle>
              </Divstyled>
          ...
          <Divstyled className='des mt-4'>
            ...
            <Psyled className="lg:text-[14px] md:text-[13px] text-[12px] text-[#999] mt-4 p-2 rounded bg-[#99999924]">{c.des ? c.des : 'Trống!'}</Psyled>
          </Divstyled>
        </Divstyled>
      </Divstyled>}
    </Divstyled>
