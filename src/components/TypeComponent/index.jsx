...
import { getCategoryMain } from '../../api/seris';
import index from '../../page/Admin/Cart/CartAdmin';
...
const DivStyledBtnContent = styled.div``;
    ...
    <DivStyled>
      <DivStyledContent>
        <DivStyledItem>
          ...
          <DivStyledBtn >
            {categorymain ? categorymain.map((item, index) => (
