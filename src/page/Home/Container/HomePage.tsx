...
const HomePage = () => {
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ width: state ? '91.666667%' : '', opacity: 1 }}
      exit={{ transition: { duration: 0.1 }, opacity: 0 }}
      className={'lg:w-10/12 md:w-10/12 sm:w-12/12 index p-2'}
    >
      <Divstyled className={state ? "form-outline searchHeader p-2" : "form-outline searchHeader"}>
        <Divstyled className='d-flex items-center'>
          ...
          <a href={'https://github.com/NamPgn'}>
            <BtnStyled style={{ width: "210px" }} type="button" className="ml-5 text-white bg-[#1da1f2] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 ">
